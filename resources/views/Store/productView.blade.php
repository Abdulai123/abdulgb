        ...
        <div class="photo">
            ...
            <div class="desc-others">
                <div class="description">
                    <h3>DESCRIPTIONS</h3>
                    <p class="contents" style="text-align: left; white-space: pre-wrap;">{{ $product->product_description }}</p>
                </div>
                @if ($product->return_policy != null)
                    <div class="refund-policy">
                        <h3>Refund Policy</h3>
                        <p style="text-align: left; white-space: pre-wrap;">{{ $product->return_policy }}</p>
                    </div>
                @endif
            </div>
        </div>
            ...
            <div class="info-overvew">
                ...
                <div>
                    ...
                    <div class="price" style="margin-bottom: 10px">
                        ...
                        <h3 style="margin: 10px"> <img src="data:image/png;base64,{{ $icon['xmr'] }}" width="25"> {{ session('xmr') != null ? round(($product->price / session('xmr')), 3) : null }} XMR
                        </h3>
...
<div class="main-div">
    ...
    <div class="products-overview">
        ...
        @endforelse
        @if ($product->reviews->count() > 15)
            <a href="/store/{{ $store->store_name }}/show/product/reviews/{{ $product->created_at->timestamp }}/{{ $product->id }}"
