...
@endif
        ...
        <div class="wallet-section">
            <fieldset>
                ...
                <form action="/store/{{ $store->store_name }}/wallet/withdraw" method="post" class="wallet-form">
                    @csrf
                    <div class="balance-item">
                        <p style="color:green;"><span>Wallet Balance</span><br><span style="font-weight: 800;">${{ $store->user->wallet->balance }} / {{ session('xmr') == null ? "xmr api problem open a support ticket." : round($store->user->wallet->balance/session('xmr'),3) }} XMR</span></p>
                    </div>
                    {{-- <div class="balance-item">
        ...
        <h3>Withdraw History</h3>
            <table>
                ...
                <tbody>
                    @forelse ($store->user->wallet->withdraw->sortByDesc('created_at') as $withdraw)
                        <tr>
                            <td>
