...
<table>
    ...
    <tbody>
        <form action="/whales/admin/{{ $user->public_name }}/show/stores/search" method="get" style="text-align: center">
            <tr>
                <td>
    ...
    <tbody>
        ...
        @forelse ($stores as $store)
            ...
            <tr>
                ...
                <td>
                    <a href="/whales/admin/show/store/{{ $store->created_at->timestamp }}/{{ $store->id }}"
