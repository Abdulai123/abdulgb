...
<table>
    ...
    <tbody>
        <form action="/whales/admin/{{ $user->public_name }}/show/unauthorizes/search" method="get" style="text-align: center">
            <tr>
                <td>
...
<table>
    ...
    <tbody>
        @php
         $unauthorizes = session('unauthorizes') ?? \App\Models\Unauthorize::paginate(50);
        @endphp
