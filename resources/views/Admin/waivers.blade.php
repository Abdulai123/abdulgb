...
<table>
    ...
    <tbody>
        <form action="/whales/admin/{{ $user->public_name }}/show/waivers/search" method="get" style="text-align: center">
            <tr>
                <td>
...
<table>
    ...
    <tbody>
        @php
            $waivers = session('waivers') ?? $waivers;
        @endphp
       @forelse ($waivers as $waiver)
            ...
            <tr>
                ...
                <td>
                    <a href="/whales/admin/{{ $user->public_name }}/show/waiver/{{ $waiver->created_at->timestamp }}/{{ $waiver->id }}"
