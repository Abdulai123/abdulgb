        ...
        <div class="main-div">
            <div class="notific-container">
                <h3 style="text-align:center;">Product Reviews > <a
                        href="/whales/admin/show/product/{{ $product->created_at->timestamp }}/{{ $product->id }}"
                ...
                <table>
                    ...
                    <tbody>
                        <form action="/whales/admin/{{ $user->public_name }}/show/product/reviews/search"
                            ...
                            <div class="reviewer-reviews">
                                ...
                                <div class="rating-texts">
                                    ...
                                    @else
                                        ...
                                        <form
                                            action="/whales/admin/{{ $user->public_name }}/flag/review/{{ $review->id }}"
