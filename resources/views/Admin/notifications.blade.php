<div class="notific-container">
    ...
    <table>
        ...
        <tbody>
            <form action="/whales/admin/{{ $user->public_name }}/notifications/show/search" method="get" style="text-align: center">
                <tr>
                    <td>
        ...
        <div class="notification-container {{ $notification->is_read ? 'read' : '' }}">
            ...
            <div class="notification-content">
                <div style="display: flex;">
                    ...
                    <form action="/whales/admin/notification/{{ $notification->created_at->timestamp }}/{{ $notification->id }}"
                        method="post">
                        @csrf
