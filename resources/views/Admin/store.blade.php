...
<div class="main-div" style="margin-top:0px">
    <div class="main-store-div">
        ...
        <form action="" method="post" style="margin-top:1em;">
            ...
            @endif
                <a href="/whales/admin/show/store/reviews/{{ $store->created_at->timestamp }}/{{ $store->id }}" class="input-listing">See Reviews({{ $store->reviews->count() }})</a>
        </form>
    </div>
    ...
    <div class="main-store-div">
        ...
        <form action="">
            <table>
                ...
                <tbody>
                    @forelse ($store->user->wallet->deposit->sortByDesc('created_at') as $deposit)
                        <tr>
