            ...
            <fieldset>
                ...
                <form action="" method="post" class="wallet-form">
                    ...
                    <div class="balance-item">
                        <p style="color:green;"><span>Wallet Balance</span><br><span
                                style="font-weight: 800;">${{ $user->wallet->balance }} /
                                {{ session('xmr') == null ? 'xmr api problem open a support ticket.' : round($user->wallet->balance / session('xmr'), 3) }}
                                XMR</span></p>
                    </div>
                    {{-- <div class="balance-item">
