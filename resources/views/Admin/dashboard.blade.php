<div class="latest-orders">
    ...
    <div class="title-latest">
        ...
        <div class="view-latest">
            <a href="/whales/admin/{{ $user->public_name }}/show/new stores">VIEW ALL</a>
        </div>
    </div>
    <div>
        <table>
...
<div class="top-products">
    <div class="title-latest">
        ...
        <div class="view-latest">
            <a href="/whales/admin/{{ $user->public_name }}/show/products">VIEW ALL</a>
        </div>
    </div>
    <div>
        <table>
                    ...
                    <tr>
                        ...
                        <td>
                            <form action="" method="post">
                                ...
                                <a href="/whales/admin/show/product/{{ $product->created_at->timestamp }}/{{ $product->id }}"
                                    style="font-size: .7rem; background-color: rgb(0, 75, 128); color: #f1f1f1; cursor:pointer; padding: 5px; border: none; border-radius: .5rem;">Review</a>
