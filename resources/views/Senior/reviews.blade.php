<h3 style="text-transform: capitalize; text-align: center;">
    <span style="color:#28a745">
        All Reviews ({{ \App\Models\Review::all()->count() }})
    </span>
    <hr>
</h3>
...
<table>
    ...
    <tbody>
        <form action="/senior/staff/{{ $user->public_name }}/show/reviews/search" method="get"
...
@php
    $reviews = session('reviews') ?? \App\Models\Review::orderByDesc('created_at')->paginate(50);
@endphp
        ...
        <div class="displayed-reviews" style="padding: 0px;">
            ...
            <div class="reviewer-reviews">
                ...
                <div class="rating-texts">
                    <a
                        href="/senor/staff/show/product/{{ $review->product->created_at->timestamp }}/{{ $review->product->id }}">{{ $review->product->product_name }}</a>
