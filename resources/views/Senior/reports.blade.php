...
<table>
    ...
    <tbody>
        <form action="/senior/staff/{{ $user->public_name }}/show/reports/search" method="get" style="text-align: center">
            <tr>
                <td>
...
<table>
    ...
    <tbody>
        @php
            $reports = session('reports') ?? \App\Models\Report::orderByDesc('created_at')->paginate(50);
        @endphp
