    ...
    <div class="notific-container">
        ...
        <div class="container-pgp">
            ...
            @if (session('encrypted_message_verify'))
                @include('Senior.verify')
            @else
                <form action="/senior/staff/{{ $user->public_name }}/do/pgp" method="post">
                    @csrf
                    <h1>PGP KEY [2FA]</h1>
                    ...
                    <div id="capatcha-code-img">
                        <img src="/senior/staff/{{ $user->public_name }}/captcha" alt="none yet" srcset="">
                    ...
                    <label for="2fa"
                        ...
                        <input type="checkbox"
                            ...
                            class="enable2fa" name="updating2fa"
                            {{ $user->twofa_enable == true ? 'checked required' : '' }}>
                    </label>
                    <div class="two-btns">
