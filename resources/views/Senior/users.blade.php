...
<table>
    ...
    <tbody>
        <form action="/senior/staff/{{ $user->public_name }}/show/users/search" method="get" style="text-align: center">
            <tr>
                <td>
...
<table>
    ...
    <tbody>
        @php
        $users = session('users') ?? \App\Models\User::orderByDesc('created_at')->where('role', 'user')->paginate(50);
        @endphp
