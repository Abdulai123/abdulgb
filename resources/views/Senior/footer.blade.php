  ...
  <div class="seco-div">
    ...
    <div class="right-div">
      <div class="canary-news">
        <a href="/senior/staff/{{ $user->public_name }}/show/settings">Settings</a>
        <a href="/senior/staff/{{ $user->public_name }}/show/canary">Canary & PGP KEYs</a>
        <a href="/senior/staff/{{ $user->public_name }}/show/faq">F.A.Q</a>
      </div>
      <p class="lunched">
