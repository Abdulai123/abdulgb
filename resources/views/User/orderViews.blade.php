            ...
            <div class="notific-container">
                ...
                <p style="font-family: Verdana, Geneva, Tahoma, sans-serif; margin-bottom: 2em;">
                    ...
                    <a style="font-size: 1em;"
                        href="/store/show/message/{{ $order->product->store->store_name }}/{{ $order->product->store->created_at->timestamp }}/{{ $order->store_id }}"
                        target="_blank">
                ...
                <p style="font-size: 1em; font-family: Verdana, Geneva, Tahoma, sans-serif; font-style:oblique;">
                    <span style="color: darkorange;">Dispute this order:</span> This option is available if more than 3
                ...
                <p style="font-size: 1em; font-family: Verdana, Geneva, Tahoma, sans-serif; font-style:oblique;">
                    <span style="color: darkgreen;">Release funds for this Order:</span> Click the button to confirm
                    order
                    completion. This indicates a successful transaction and satisfaction. Afte that you can scrow down
                    to leave review for thsi order!
                </p>
                                ...
                                <form action="" method="post">
                                    ...
                                    @else
                                        @switch($order->status)
                                            ...
                                            @case('dispatched')
                                                <input type="submit" name="dispute" class="dispute"
                                                    value="Dispute this order"
                                                    style="cursor: pointer;  margin:.4em; font-weight:bold">
                                                <input type="submit" name="release" class="release"
                                                    value="Release funds for this order"
                                                    style="cursor: pointer;  margin:.4em; font-weight:bold">
